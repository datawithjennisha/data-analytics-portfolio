...
This portfolio showcases end-to-end analytics projects built using SQL, Power BI, Tableau, Excel, and Python. The projects focus on data cleaning, exploratory data analysis (EDA), dashboard development, KPI reporting, business intelligence, and actionable insights generation using real-world datasets.

---

# About Me

Aspiring Data Analyst with hands-on experience in SQL, Power BI, Tableau, Excel, and Python. Passionate about transforming raw data into meaningful business insights through interactive dashboards, reporting solutions, and analytical storytelling.
...
| BI & Reporting | DAX, KPI Reporting |
...
This folder contains interactive Power BI dashboards focused on KPI tracking, sales analytics, customer behavior analysis, and business reporting.

| Project | Key Focus | Tools |
|----------|------------|-------|
| Sales Performance Dashboard | Revenue & KPI Tracking | Power BI, DAX |
| Customer Churn Analysis | Retention Insights | Power BI, SQL |
| HR Analytics Dashboard | Employee Attrition | Power BI |
| Financial Analysis Dashboard | Profitability Analysis | Power BI, Excel |

📁 Folder: `PowerBI_Projects`

---

## 📈 Tableau Projects

This folder contains Tableau dashboards designed for interactive storytelling, trend analysis, and business performance monitoring.

| Project | Key Focus | Tools |
|----------|------------|-------|
| Global Superstore Analysis | Sales & Profit Insights | Tableau |
| Customer Segmentation Dashboard | Consumer Analysis | Tableau |
| Regional Sales Dashboard | Market Trends | Tableau |
| E-commerce Dashboard | Revenue Visualization | Tableau |

📁 Folder: `Tableau_Projects`

---

## 🗄 SQL Projects

This folder includes SQL projects focused on querying, data transformation, KPI calculations, joins, CTEs, window functions, and business reporting.

| Project | Key Focus | Skills Used |
|----------|------------|-------------|
| Retail Sales Analysis | Sales Trends | GROUP BY, JOINS |
| Customer Churn Analysis | Retention Metrics | CTEs, CASE WHEN |
| E-commerce Order Analysis | Business KPIs | Window Functions |
| Banking Analytics | Transaction Analysis | Aggregations, Subqueries |
...
This folder contains Python-based analytics projects focused on data cleaning, EDA, visualization, and automation.

| Project | Key Focus | Libraries |
|----------|------------|------------|
| Netflix Data Analysis | Exploratory Data Analysis | Pandas, Matplotlib |
| Sales Data Analysis | Business Insights | Pandas, NumPy |
| Customer Segmentation | Data Visualization | Pandas |
| Data Cleaning Pipeline | ETL & Preprocessing | Python |
...
This folder contains Excel dashboards and reporting projects using pivot tables, lookup functions, charts, and KPI analysis.

| Project | Key Focus | Excel Features |
|----------|------------|----------------|
| Sales Dashboard | KPI Reporting | Pivot Tables |
| HR Analytics Report | Employee Metrics | VLOOKUP, Charts |
| Financial Tracker | Budget Analysis | Conditional Formatting |
| Inventory Dashboard | Stock Monitoring | Excel Functions |

📁 Folder: `Excel_Projects`
...
- Add cloud-based analytics projects
